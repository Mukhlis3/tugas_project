...
<div class="wrapper-login">
  <div class="card overflow-hidden account-card mx-3">
    <div class=" text-white text-center position-relative" style="background-color:grey;padding-top:25px; padding-bottom:35px;">
      <h4 class="font-20 m-b-5">Selamat Datang</h4>
      <p class="font-20 m-b-5">SMK LENTERA BANGSA </p>
      <a href="" class="logo logo-admin"><img class="rounded-circle" src="../assets/img/profile1.png" height="78" alt="logo"></a>
    </div>
    ...
    <div class="account-card-content">
      <form action="" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="id_pengguna" name="id_pengguna" placeholder="Masukan ID">
        </div>
        ...
        <div class="form-group row m-t-20">
          ...
          <div class="col-sm-6 text-right">
            <button class="btn  w-md waves-effect waves-light" style="background-color:grey; color:white;" type="submit" name="login">Masuk</button>
          </div>
        </div>
