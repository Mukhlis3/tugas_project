      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            ...
            <a href="?p=tambah_murid" class="btn btn-primary btn-round btn-sm ml-auto"> <i class="fas fa-plus mr-2"></i> Tambah</a>
          </div>
        </div>
        <div class="card-body">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="?p=ubah_murid&nisn=<?php echo $murid['nisn'] ?>" class="btn btn-primary btn-round btn-sm"> <i class="fas fa-edit mr-2"></i> Ubah</a> 
                      <a href="?p=hapus_murid&nisn=<?php echo $murid['nisn'] ?>" onclick="validateRemove(event)" class="btn btn-danger btn-round btn-sm"> <i class="fas fa-trash-alt mr-2"></i> Hapus</a>
                    </td>
                  </tr>
                <?php
                    }
