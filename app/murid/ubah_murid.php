<?php
  ...
  $data_murid = $murid->getInfoDetailSiswa($nisn);
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Form Ubah Data Siswa</h4>
        </div>
        <div class="card-body">
          ...
          <form name="frmUbahMasterTindakan" method="POST" action="">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nisn" value="<?php echo $data_murid['nisn'] ?>" maxlength="10" required readonly>
            </div>
            <div class="form-group">
              <label for="nama_siswa">Nama Siswa</label>
              <input type="text" class="form-control" name="nama_siswa" value="<?php echo $data_murid['nama_siswa'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="jenis_kelamin">Jenis Kelamin</label>
              <input type="text" class="form-control" name="jenis_kelamin" value="<?php echo $data_murid['jenis_kelamin'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="ttl">Tempat Tanggal Lahir</label>
              <input type="text" class="form-control" name="ttl" value="<?php echo $data_murid['ttl'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="agama">Agama</label>
              <input type="text" class="form-control" name="agama" value="<?php echo $data_murid['agama'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="status_dalam_keluarga">Status dalam Keluarga</label>
              <input type="text" class="form-control" name="status_dalam_keluarga" value="<?php echo $data_murid['status_dalam_keluarga'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="anak_ke">Anak Ke</label>
              <input type="text" class="form-control" name="anak_ke" value="<?php echo $data_murid['anak_ke'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="alamat_peserta_didik">Alamat Peserta Didik</label>
              <input type="text" class="form-control" name="alamat_peserta_didik" value="<?php echo $data_murid['alamat_peserta_didik'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="nomor_telp_rumah">Nomor Telepon Rumah</label>
              <input type="text" class="form-control" name="nomor_telp_rumah" value="<?php echo $data_murid['nomor_telp_rumah'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="sekolah_asal">Sekolah Asal</label>
              <input type="text" class="form-control" name="sekolah_asal" value="<?php echo $data_murid['sekolah_asal'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="diterima_disekolah_ini">Diterima di Sekolah Ini</label>
              <input type="text" class="form-control" name="diterima_disekolah_ini" value="<?php echo $data_murid['diterima_disekolah_ini'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="nama_ayah">Nama Ayah</label>
              <input type="text" class="form-control" name="nama_ayah" value="<?php echo $data_murid['nama_ayah'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="nama_ibu">Nama Ibu</label>
              <input type="text" class="form-control" name="nama_ibu" value="<?php echo $data_murid['nama_ibu'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="pekerjaan_ayah">Pekerjaan Ayah</label>
              <input type="text" class="form-control" name="pekerjaan_ayah" value="<?php echo $data_murid['pekerjaan_ayah'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="pekerjaan_ibu">Pekerjaan Ibu</label>
              <input type="text" class="form-control" name="pekerjaan_ibu" value="<?php echo $data_murid['pekerjaan_ibu'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="alamat_orang_tua">Alamat Orang Tua</label>
              <input type="text" class="form-control" name="alamat_orang_tua" value="<?php echo $data_murid['alamat_orang_tua'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="nama_wali">Nama Wali</label>
              <input type="text" class="form-control" name="nama_wali" value="<?php echo $data_murid['nama_wali'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="alamat_wali">Alamat Wali</label>
              <input type="text" class="form-control" name="alamat_wali" value="<?php echo $data_murid['alamat_wali'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
              <label for="pekerjaan_wali">Pekerjaan Wali</label>
              <input type="text" class="form-control" name="pekerjaan_wali" value="<?php echo $data_murid['pekerjaan_wali'] ?>" maxlength="30" required>
            </div>
            <div class="form-group">
